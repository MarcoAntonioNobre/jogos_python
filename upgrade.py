...
botao_back2 = Button("Tecle J para Sair do Jogo", (WIDTH_GAMEOVER_BUTTON_TELA_PAUSE, HEIGHT_GAMEOVER_BUTTON_SAIR_TELA_PAUSE),
                     (333, 53), BLACK,
                     BLACK, BACKGame)
botao_back = Button("Tecle J para Sair do Jogo", (WIDTH_GAMEOVER_BUTTON_TELA_PAUSE, HEIGHT_GAMEOVER_BUTTON_SAIR_TELA_PAUSE),
                    (330, 50), RED,
                    WHITE,
                    BACKGame)
...
class Upgrade:
    ...
    def display(self):
        ...
        botao_back2.draw(self.display_surface)
        botao_back.draw(self.display_surface)
